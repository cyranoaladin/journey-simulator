...
/**
 * Extended agents (au-delà du Core 17). Chargés uniquement hors test.
 */
module.exports = [
  ...
  { agentId: 'CommunityAgent', domain: 'growth', capabilities: ['community', 'engagement'], intents: ['community'], requiresRag: false, priority: 80, enabled: true },
  { agentId: 'GovernanceAgent', domain: 'governance', capabilities: ['strategy', 'policy'], intents: ['governance'], requiresRag: false, priority: 81, enabled: true },
  { agentId: 'LaunchpadAgent', domain: 'investor', capabilities: ['incubation', 'launch'], intents: ['launchpad'], requiresRag: false, priority: 78, enabled: true },
  { agentId: 'OnboardingAgent', domain: 'ux', capabilities: ['onboarding', 'flows'], intents: ['onboarding'], requiresRag: false, priority: 85, enabled: true },
  { agentId: 'PitchAgent', domain: 'investor', capabilities: ['pitch', 'deck'], intents: ['pitch'], requiresRag: false, priority: 82, enabled: true },
  { agentId: 'ProductAgent', domain: 'product', capabilities: ['discovery', 'strategy'], intents: ['product'], requiresRag: false, priority: 89, enabled: true },
  { agentId: 'TokenAgent', domain: 'tokenomics', capabilities: ['utility', 'mapping'], intents: ['token_design'], requiresRag: false, priority: 84, enabled: true },
