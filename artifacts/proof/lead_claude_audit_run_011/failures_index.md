...
[failed] 01-navigation/comprehensive-menu.spec.ts:66: Menu Navigation: DAO
  Class: OTHER
[failed] 01-navigation/header-navigation.spec.ts:62: should switch to Demo mode and update UI
  Class: UI_STATE_SYNC
[failed] 01-navigation/header-navigation.spec.ts:70: should switch to Simulation mode and update UI
  Class: UI_STATE_SYNC
...
[failed] 05-agents-orchestration/multi-user-isolation.spec.ts:17: Two users have isolated orchestration state
  Class: AUTH_FLOW
[failed] supreme-auditor.spec.ts:6: Dashboards & Navigation Consistency Check
  Class: SUPREME
[failed] supreme-integrity.spec.ts:6: Security Breach: Mode Mismatch Rejection
  Class: SUPREME
[failed] supreme-integrity.spec.ts:54: UI Stress: Double-Click Protection
  Class: SUPREME
[failed] supreme-integrity.spec.ts:118: Solana: Real Transaction Proof
  Class: SUPREME
