# Registre des risques (MVP)

- Latence LLM / erreurs 429: retries/backoff, DEMO_MODE par défaut, llm=1 ponctuel
- RPC devnet instable: endpoint alternatif, backoff, KILL_SWITCH
