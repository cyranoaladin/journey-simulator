...
1. **Scope limité** : L'examen s'est concentré sur la couche orchestration (`mf-back/orchestration/`) uniquement, excluant le frontend, la base de données MongoDB, et les services externes (évalués uniquement via fallbacks).
