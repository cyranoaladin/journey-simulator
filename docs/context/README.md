...
*   **Backend (`mf-back`)**: Express.js, PostgreSQL/Redis. Orchestrates specialized AI agents, manages user sessions, and handles RAG (Retrieval-Augmented Generation) operations.
...
2.  **PostgreSQL & Redis**: Running via Docker or local instances (Ports 5432, 6379).
