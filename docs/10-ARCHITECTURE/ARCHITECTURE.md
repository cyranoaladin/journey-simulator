...
graph TB
    ...
    subgraph "Backend Layer"
        API[🔧 API Server<br/>Express + Postgres]
        AGENTS[🤖 AI Agents<br/>Multi-Agent System]
    end

    subgraph "External Services"
        LLM[🧠 OpenAI GPT-4o / Ollama<br/>SDK / LocalAI]
    ...
    API -->|Stores Progress| POSTGRES
    API -->|Caches Sessions| REDIS
...
- `Journey` - Journey instances & state
- `AgentRun` - Agent execution history
- `Artifact` - Generated outputs & deliverables
- `Metric` - Analytics & AEPO scores
...
| **Backend** | Node.js 18+, Express 4.21, PostgreSQL (Prisma), Redis, JWT 9.0 |
