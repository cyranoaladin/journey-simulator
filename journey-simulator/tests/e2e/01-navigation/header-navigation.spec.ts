...
test.describe('Header Navigation - Zero-Failure Path', () => {
    ...
    test('should switch to Demo mode and update UI', async ({ page }) => {
        const demoButton = page.getByTestId('mode-switch-demo');
    ...
    test('should switch to Simulation mode and update UI', async ({ page }) => {
        const simulationButton = page.getByTestId('mode-switch-simulation');
        await simulationButton.waitFor({ state: 'visible', timeout: 10000 });
