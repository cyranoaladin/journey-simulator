...
export const AECO: AepoAecoDefinition = {
  ...
  examples: [
    ...
    'Certificate cohort: synchronized phases and AI-led sessions with collective retrospectives.',
  ],
}
