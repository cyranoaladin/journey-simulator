...
function MetricCard({ label, value, suffix, delta, icon: Icon, color }: typeof METRICS[0]) {
  return (
        ...
        <div className="grid grid-cols-[1fr_300px] gap-4">
          <Card padding="lg">
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-xs text-ink-400 mt-0.5">Cognitive Activation Protocol™ — Phase 2/6</p>
              </div>
          ...
          <Card padding="lg">
            ...
            <div className="flex flex-col items-center">
              <div className="text-5xl font-mono font-bold text-gold-300">74</div>
              <p className="text-2xs text-ink-400 mt-2 uppercase tracking-wider">INTERMEDIATE</p>
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 stagger">
          ...
          <Card variant="gold" padding="md">
            ...
            <p className="text-xs text-ink-200 leading-relaxed mb-4">
              Votre score de maîtrise Web3 (88/100) est excellent. Concentrez-vous sur la collaboration DAO.
            </p>
