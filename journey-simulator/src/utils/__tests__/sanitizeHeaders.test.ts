...
describe('sanitizeHeaders', () => {
    ...
    it('should apply pattern-based safety net for Bearer tokens in custom headers', () => {
        const input = {
            'x-debug': 'Bearer <REDACTED_JWT_TOKEN>',
            'x-trace-id': '123456'
        };
    ...
    it('should apply pattern-based safety net for JWT-like values in custom headers', () => {
        const input = {
            'x-custom': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
