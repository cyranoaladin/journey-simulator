...
export const journeyApi = {
    ...
    getInteractionHistory: async (): Promise<{ success: boolean; history: any[] }> => {
        return executeRequest<{ success: boolean; history: any[] }>(`/journey/history?t=${Date.now()}`, {
            method: 'GET'
        });
    },
