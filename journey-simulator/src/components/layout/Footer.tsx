  ...
  return (
    <footer className="border-t border-white/10 py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between w-full opacity-60 text-sm">
            <p className="mb-2 md:mb-0">© 2026 Money Factory AI. All rights reserved.</p>
            <p className="text-xs text-center md:text-right max-w-lg mt-2 md:mt-0">
              Money Factory AI is a high-fidelity simulator. No real SOL/MFAI tokens are moved in Demo Mode. Verify Mainnet status in Zyno Console.
            </p>
          </div>
