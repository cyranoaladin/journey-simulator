...
export const personas: Persona[] = [
  {
    ...
    phases: [
      ...
      },
      {
        ...
        title: 'Launch via Collaterize',
        description: 'Simulate your project launch on the Collaterize platform to test your readiness for the Core Track.',
        mission: 'Run the Collaterize simulation, analyze your eligibility score, and review the launch plan.',
        duration: '1 week',
        xpReward: 200,
        mfaiReward: 20,
        nftReward: 'Collaterize Launch Badge',
        tools: ['Collaterize Simulator', 'Launch Readiness Checklist'],
        outcomes: ['Eligibility Score', 'Launch Tier Assessment', 'Simulated Launch Plan'],
