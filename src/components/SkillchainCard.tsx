    ...
    if (connectionError) {
      return (
        <div className="flex items-center">
          ...
          <span className="opacity-80 text-red-400">
    ...
    <div className={`perspective fixed-card-container ${className}`}>
      ...
      >
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <div className={`${tier.color} text-sm font-semibold`}>
                  {tier.name} Tier
                </div>
              </div>
              <div
                className={`w-12 h-12 ${tier.gradient} rounded-lg flex items-center justify-center shadow-lg`}
              >
            ...
            <div className="mb-4">
              ...
              <div className="flex justify-between items-center text-sm text-white/90 mt-1">
                ...
                <span className="font-medium">
                  {selectedPersona?.title || "None selected"}
                </span>
              </div>
            </div>
            ...
            <div className="mt-4 text-xs text-white/60 font-mono flex justify-between">
              <span>
                ID: MFAI-{Math.random().toString(36).substr(2, 8).toUpperCase()}
              </span>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="font-space font-bold text-white text-lg mb-4">
                ...
                <div className="space-y-1">
                  {userProgress.completedPhases.map((phaseIndex) => (
                    ...
                    >
                      ...
                      <span>
                        {selectedPersona.phases[phaseIndex].title}:{" "}
                        {selectedPersona.phases[phaseIndex].xpReward} XP
                      </span>
                    </div>
                  ))}
                </div>
            ...
            <div className="mt-4 text-center">
              <div className="text-xs text-white/60 italic">
                "Every proof you mint is a piece of your sovereign capital. This
                card grows with your skills."
              </div>
