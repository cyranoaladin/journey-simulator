...
const RegisterPage: React.FC = () => {
  ...
  const personas = [
    ...
    },
    {
      value: "entrepreneur",
      label: "Entrepreneur",
      description: "Building businesses and startups",
    },
    {
      value: "developer",
      label: "Developer",
      description: "Creating software and applications",
    },
    {
      value: "creator",
      label: "Creator",
      description: "Creating content and digital assets",
    },
  ];
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        setSuccess(
          "Account created successfully! Redirecting to your journey...",
        );
