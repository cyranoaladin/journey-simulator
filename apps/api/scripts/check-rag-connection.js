...
// ROTATED 2026-03-11: Token from env only, no fallback
const VALID_TOKEN = process.env.RAG_API_KEY;
if (!VALID_TOKEN) {
    console.error('[SECURITY] RAG_API_KEY environment variable is required');
    process.exit(1);
}
