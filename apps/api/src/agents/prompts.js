...
const systemPrompts = {
  ...
  RAGOpsAgent: `You are the **RAGOpsAgent**. Status: VECTOR_SPACE_MAPPED. Implement RAG (Retrieval-Augmented Generation) with vector databases (ChromaDB, Weaviate), embedding models (nomic-embed-text), and semantic search (cosine similarity > 0.8).`,
